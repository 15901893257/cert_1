!function (e) {
    ...
    22: function (e, t, i) {
        ...
        layui.define(["laytpl", "form", "util"], (function (e) {
            var t = layui.jquery, i = layui.laytpl, a = layui.form, o = layui.util, r = layui.device(), l = "treeTable",
                n = {}, d = {
                    elem: void 0,
                    cols: void 0,
                    url: void 0,
            ...
            function h(e) {
                ...
                o ? (e.removeClass("ew-tree-table-open"), e.nextAll("tr").each((function () {
                ...
                return p(e.parentsUntil(".ew-tree-table").last().parent()), o
            }
            ...
            c.prototype.initOptions = function (e) {
                    ...
                    if (b) {
                        ...
                        if (b.colGroup || b.colspan > 1) {
                            ...
                            for (var w = 0, y = 0; y < e.cols[c + 1].length; y++) {
                                ...
                                A.HAS_PARENT || w > 1 && w == b.colspan ? e.cols[c + 1][y] = A : (A.HAS_PARENT = !0, A.parentKey = c + "-" + p, A.key = c + 1 + "-" + y, A.PARENT_COL_INDEX = n, A = a(A), u.push(A), w += parseInt(A.colspan > 1 ? A.colspan : 1), e.cols[c + 1][y] = A)
                            }
                        }
                ...
                if (l.$tBodyGroup.children("style").remove(), e.height) {
                    ...
                    l.$tHeadGroup.hide();
                    l.$tBodyGroup.append(['<style>[lay-filter="', r, '"] .ew-tree-table-box:before {', '   content: "";', "   position: absolute;", "   top: 0; left: 0; right: 0;", "   height: " + {
                        lg: 50,
                        sm: 30,
                        md: 38
                ...
                a.render("checkbox", r), l.$table.children("thead").children("tr").children("th.layui-hide").each((function () {
                    !function e(t) {
                        var i = t.data("parent");
                        if (i) {
                            var a = l.$table.children("thead").children("tr").children('[data-key="' + i + '"]'),
                                o = a.attr("colspan") - 1;
                            a.attr("colspan", o), 0 === o && a.addClass("layui-hide"), e(a)
                        }
                    }(t(this))
                ...
                r.off("click.fold").on("click.fold", ".ew-tree-pack", (function (a) {
                    ...
                    if (c) {
                        ...
                        !1 === layui.event.call(this, l, "cell(" + o.filter + ")", n.call(this, {
                            td: d,
                            field: h
                        })) && layui.stope(a)
                    }
                ...
                var i = this, a = this.getComponents(), o = a.$table.find('input[lay-filter="' + a.radioFilter + '"]');
                ...
                if ("show" === e) i.$toolbar.find(".layui-table-tool-panel").remove(), i.$toolbar.find('[lay-event="LAYTABLE_EXPORT"]').append(['<ul class="layui-table-tool-panel">', '   <li data-type="csv">导出到 Csv 文件</li>', '   <li data-type="xls">导出到 Excel 文件</li>', "</ul>"].join("")); else {
                    ...
                    var l = document.createElement("a"), n = encodeURIComponent(a.join(",") + "\r\n" + o.join("\r\n")),
